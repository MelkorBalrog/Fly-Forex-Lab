...
A v3 counterpart is now available — see
`banc_888_edgelist_split_v3.feather` — built by the same
flow-centrality split pipeline against the v3 synapse detection set.
